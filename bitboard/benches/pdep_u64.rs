...
impl BB {
	#[inline]
	fn pdep_bmi2(&self, mask: &Self) -> u64 {
		#[cfg(target_feature = "bmi2")]
		unsafe {
			std::arch::x86_64::_pdep_u64(self.bits, mask.bits)
		}
	...
	#[inline]
	fn pdep_fallback(&self, mask: &Self) -> u64 {
		let mut res: u64 = 0;
		let mut bit: u64 = 1;
		let mut m = mask.bits;
		let mut v = self.bits;
...
criterion_group!(benches, bench_pdep);
